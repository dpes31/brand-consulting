...
assert.match(colorFixes, /#strategy-choice \.choice-final/);
assert.match(colorFixes, /#identity \.founding-jtbd-note/);
assert.match(colorFixes, /#appendix-evidence \.evidence-gap-grid > div/);
assert.match(colorFixes, /grid-template-columns: 118px minmax\(0, 1fr\)/);
